...
from case_hardening_toolbox.case_hardening_materials.gear_materials import SS2506
...
simulations = [Simulation(simulation_directory='2',
...
for simulation in simulations:
    ...
    toolbox_writer.cooldown_data.temperature = 25
