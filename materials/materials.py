...
SS2506 = ElasticPlasticTransformMaterial(E=200e3, v=0.27, sy0M=(-822.30547065, 2.54556396),
                                         ...
                                         a=np.array([0.004592167619413511, 2.041371210537882e-05,
                                                     6.304773306247823e-07]),
                                         Ms=179.91803165833332, name='SS2506', Mss=-34.34482367829672, fM=0.85,
                                         beta=0., alpha=129.5, n=4., sde=0.00,
                                         # beta=841.893, alpha=129.5, n=4., sde=0.00,
                                         g0=-0*1.918/2, g1=5.18, g2=0*1.918/2., g_mean=0, g_std=1.,
                                         fsb0=0.12948)
...
SS2506.R1 = 0.030127568010249295
SS2506.R2 = 1.691828308519001e-5
