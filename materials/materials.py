...
SS2506_no_trans = ElasticPlasticTransformMaterial(E=195e3, v=0.27, sy0M=(952, 0),
                                                  sy0A=(-343.5635802, 0.99164101),
                                                  Q=(0., 0.), b=(100., 0.),
                                                  Cm=np.array([(45737.7179606, 0.),
                                                               (495435.61667728,  0.),
                                                               (742087.72470321, 0.)]),
                                                  gamma_m=np.array([(54.12564056, 0.),
                                                                    (493.03665122, 0.),
                                                                    (3102.09170631, 0.)]),
...
SS2506 = ElasticPlasticTransformMaterial(E=195e3, v=0.27, sy0M=(952*100000, 0.),
                                         sy0A=(-343.5635802, 0.99164101),
                                         Q=(0., 0.), b=(100., 0.),
                                         Cm=np.array([(45737.7179606, 0.),
                                                      (495435.61667728,  0.),
                                         ...
                                         gamma_m=np.array([(54.12564056, 0.),
                                                           (493.03665122, 0.),
                                                           (3102.09170631, 0.)]),
                                         a=np.array([0.037936378433269996, 2e-4, 0.e-7]),
                                         Ms=179.91803165833332, name='SS2506', Mss=-106, fM=0.85,
                                         beta=0., alpha=129.5, n=4., sde=0.00,
                                         # beta=841.893, alpha=129.5, n=4., sde=0.00,
                                         g0=-0*1.918/2, g1=5.18, g2=0*1.918/2., g_mean=0, g_std=1.,
                                         fsb0=0.12948)
...
SS2506.R1 = 0.031348931861742146
SS2506.R2 = 2.27015956732029e-05
