...
SS2506 = ElasticPlasticTransformMaterial(E=195e3, v=0.27, sy0M=(552.94333009, -0.41061026),
                                         ...
                                         a=np.array([0.03423423032407406, 0.00029756681149957286, 0]),
                                         Ms=179.91803165833332, name='SS2506', Mss=-109, fM=0.8,
                                         beta=0., alpha=129.5, n=4., sde=0.00,
                                         # beta=841.893, alpha=129.5, n=4., sde=0.00,
                                         g0=-0*1.918/2, g1=5.18, g2=0*1.918/2., g_mean=0, g_std=1.,
                                         fsb0=0.12948)
...
SS2506.R1 = 0.02202643149070134
SS2506.R2 = 0.0004936631231214125
